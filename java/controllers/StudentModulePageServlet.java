...
@WebServlet("/StudentModulePageServlet")
public class StudentModulePageServlet extends HttpServlet {
        ...
        if (courseIdStr != null) {
            try {
               ...
               List<Assignment> assignments = AssignmentDao.getAllAssignments();
                ...
                request.getRequestDispatcher("student-pages/student-course-module.jsp").forward(request, response);
